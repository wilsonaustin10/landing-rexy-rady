    ...
    <footer className="bg-footer-bg text-footer-text">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <Image
                src="/https:&#x2F;&#x2F;firebasestorage.googleapis.com&#x2F;v0&#x2F;b&#x2F;allied-advantage-automation.firebasestorage.app&#x2F;o&#x2F;logos%2F1752787820502-8ybsb6%2FOTW%20Banner.png?alt&#x3D;media&amp;token&#x3D;60828406-498e-4a0b-a147-ad90bb0ff261"
                alt="Rexy Rady"
                width={120}
                height={120}
                className="mr-2"
        ...
        <div className="mt-12 pt-8 border-t border-footer-text/20 text-center text-footer-text/80">
          <p>© {new Date().getFullYear()} Rexy Rady. All rights reserved.</p>
